...
control RouterIngress(inout headers hdr,
    ...
    action ip_forward(mac_address_t self_address) {
        hdr.ethernet.src_address = self_address;
    }
    ...
    table dest_check {
        ...
        size = 1024;
        default_action = ethernet_switch();
    }

    action ipv4_forward(mac_address_t dst_address, egress_spec_t port) {
