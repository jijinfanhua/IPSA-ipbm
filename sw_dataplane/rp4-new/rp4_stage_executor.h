...
public:
    ...
    Rp4StageExecutorEntry(std::string _action_name, std::string _stage_name) : action_name(std::move(_action_name)), stage_name(std::move(_stage_name)) {}
...
public:
    ...
    void addExecutor(std::vector<Rp4StageExecutorEntry> &_entries) {
