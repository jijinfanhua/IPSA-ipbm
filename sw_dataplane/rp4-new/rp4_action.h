...
public:
    ...
    Rp4ActionDef() {}
    Rp4ActionDef(std::string _name, std::vector<Rp4FieldDef> _parameters, std::vector<Rp4Expression> _expressions, bool _is_noaction = false) : name(std::move(_name)), parameters(std::move(_parameters)), expressions(std::move(_expressions)), is_noaction(_is_noaction) {}
